...
4. In the WebHaste Extension, begin editing `index.html` to your own content.
...
Everything else — `CLAUDE.md`, `.webhaste/templates/`,
`.webhaste/site.config.json`, `.webhaste/nav.json`,
